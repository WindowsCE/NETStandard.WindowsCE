...
namespace Tests
{
    ...
    public class SemaphoreSlimTests
    {
        ...
        [TestMethod]
        public void RunSemaphoreSlimTest0_Ctor()
        {
        ...
        [TestMethod]
        public void RunSemaphoreSlimTest1_Wait()
        {
            // Infinite timeout
        ...
        [TestMethod]
        public void RunSemaphoreSlimTest1_WaitAsync()
        {
            // Infinite timeout
        ...
        [TestMethod]
        public void RunSemaphoreSlimTest2_Release()
        {
            // Valid release count
        ...
        [TestMethod]
        public void RunSemaphoreSlimTest4_Dispose()
        {
        ...
        [TestMethod]
        public void RunSemaphoreSlimTest5_CurrentCount()
        {
        ...
        [TestMethod]
        public void RunSemaphoreSlimTest7_AvailableWaitHandle()
        {
        ...
        private static void RunSemaphoreSlimTest1_WaitAsync2()
        {
            ...
            Assert.IsFalse(nonZeroObserved, "RunSemaphoreSlimTest1_WaitAsync2:  FAILED.  SemaphoreSlim.Release() seems to have synchronously invoked a continuation.");
        }
        ...
        private static void RunSemaphoreSlimTest7_AvailableWaitHandle(int initial, int maximum, SemaphoreSlimActions? action, bool state)
        {
            ...
            CallSemaphoreAction(semaphore, action, null);
            Assert.IsNotNull(semaphore.AvailableWaitHandle);
            Assert.AreEqual(state, semaphore.AvailableWaitHandle.WaitOne(0));
        }

        [TestMethod]
        public void RunSemaphoreSlimTest8_ConcWaitAndRelease_Theory()
        {
            RunSemaphoreSlimTest8_ConcWaitAndRelease(5, 1000, 50, 50, 50, 0, 5, 1000);
            RunSemaphoreSlimTest8_ConcWaitAndRelease(0, 1000, 50, 25, 25, 25, 0, 500);
            RunSemaphoreSlimTest8_ConcWaitAndRelease(0, 1000, 50, 0, 0, 50, 0, 100);
        }
        ...
        [TestMethod]
        public void RunSemaphoreSlimTest8_ConcWaitAsyncAndRelease_Theory()
        {
            RunSemaphoreSlimTest8_ConcWaitAsyncAndRelease(5, 1000, 50, 50, 50, 0, 5, 500);
            RunSemaphoreSlimTest8_ConcWaitAsyncAndRelease(0, 1000, 50, 25, 25, 25, 0, 500);
            RunSemaphoreSlimTest8_ConcWaitAsyncAndRelease(0, 1000, 50, 0, 0, 50, 0, 100);
        }
        ...
        [TestMethod]
        public void TestConcurrentWaitAndWaitAsync_Theory()
        {
