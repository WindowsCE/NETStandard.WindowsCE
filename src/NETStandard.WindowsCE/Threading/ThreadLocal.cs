...
namespace System.Threading
{
    ...
    public class ThreadLocal<T> : IDisposable
    {
        ...
        private static LocalDataStoreSlot ldss_slotArray = Thread.AllocateDataSlot();
        private static LinkedSlotVolatile[] ts_slotArray
        {
            get { return Thread.GetData(ldss_slotArray) as LinkedSlotVolatile[]; }
            set { Thread.SetData(ldss_slotArray, value); }
        }

        //[ThreadStatic]
        //private static FinalizationHelper ts_finalizationHelper;
        private static LocalDataStoreSlot ldss_finalizationHelper = Thread.AllocateDataSlot();
        private static FinalizationHelper ts_finalizationHelper
        {
            get { return Thread.GetData(ldss_finalizationHelper) as FinalizationHelper; }
            set { Thread.SetData(ldss_finalizationHelper, value); }
        }
