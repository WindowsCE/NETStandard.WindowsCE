...
namespace System.Threading
{
    ...
    public class SemaphoreSlim : IDisposable
    {
        ...
        private static readonly Task<bool> s_trueTask = new Task<bool>(true, null);
        ...
        private readonly static Task<bool> s_falseTask = new Task<bool>(false, null);
        ...
        private sealed class TaskNode : Task<bool>//, IThreadPoolWorkItem
        {
            ...
            public void ExecuteWorkItem(object ignored)
            {
                bool setSuccessfully = TrySetResult(true);
                Debug.Assert(setSuccessfully, "Should have been able to complete task");
            }
        ...
        public SemaphoreSlim(int initialCount, int maxCount)
        {
            ...
            if (maxCount <= 0)
            {
                throw new ArgumentOutOfRangeException2(nameof(maxCount), maxCount, SR.SemaphoreSlim_ctor_MaxCountWrong);
            }
            ...
            m_condition = new Condition(new WeakReference(m_lockObject));
        ...
        private static void QueueWaiterTask(TaskNode waiterTask)
        {
            ...
            ThreadPool.QueueUserWorkItem(waiterTask.ExecuteWorkItem);
        }
