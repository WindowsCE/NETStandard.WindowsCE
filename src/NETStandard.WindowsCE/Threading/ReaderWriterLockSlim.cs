...
namespace System.Threading
{
    ...
    {
        private static readonly int ProcessorCount = Environment2.ProcessorCount;
        ...
        private static int s_nextLockID;
        private int _lockID;

        // See comments on ReaderWriterCount.
        //[ThreadStatic]
        //private static ReaderWriterCount t_rwc;
        private static readonly LocalDataStoreSlot ldss_rwc = Thread.AllocateDataSlot();
        private static ReaderWriterCount t_rwc
        {
            [MethodImpl((MethodImplOptions)MethodImplOptions2.AggressiveInlining)]
            get { return Thread.GetData(ldss_rwc) as ReaderWriterCount; }

            [MethodImpl((MethodImplOptions)MethodImplOptions2.AggressiveInlining)]
            set { Thread.SetData(ldss_rwc, value); }
        }
        ...
        private struct SpinLock
        {
            ...
            private void EnterSpin(EnterSpinLockReason reason)
            {
                ...
                {
                    Interlocked2.Add(ref _enterDeprioritizationState, deprioritizationStateChange);
                }
