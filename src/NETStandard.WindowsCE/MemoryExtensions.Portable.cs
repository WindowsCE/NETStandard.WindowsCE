...
namespace System
{
    ...
    public static partial class MemoryExtensions
    {
        ...
        public static ReadOnlySpan<char> AsSpan(this string text, int start)
        {
            ...
            return new ReadOnlySpan<char>(Unsafe.As<Pinnable<char>>(text), IntPtr2.Add(StringAdjustment, start * sizeof(char)), text.Length - start);
        }
        ...
        public static ReadOnlySpan<char> AsSpan(this string text, int start, int length)
        {
            ...
            return new ReadOnlySpan<char>(Unsafe.As<Pinnable<char>>(text), IntPtr2.Add(StringAdjustment, start * sizeof(char)), length);
        }
