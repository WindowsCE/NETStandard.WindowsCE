...
namespace System
{
    internal static partial class SpanHelpers
    {
            ...
            where T : IEquatable<T>
        {
            ...
            while (length >= 8)
            {
                ...
                if (value.Equals(Unsafe.Add(ref searchSpace, index)))
                    goto Found;
                if (value.Equals(Unsafe.Add(ref searchSpace, IntPtr2.Add(index, 1))))
                    goto Found1;
                if (value.Equals(Unsafe.Add(ref searchSpace, IntPtr2.Add(index, 2))))
                    goto Found2;
                if (value.Equals(Unsafe.Add(ref searchSpace, IntPtr2.Add(index, 3))))
                    goto Found3;
                if (value.Equals(Unsafe.Add(ref searchSpace, IntPtr2.Add(index, 4))))
                    goto Found4;
                if (value.Equals(Unsafe.Add(ref searchSpace, IntPtr2.Add(index, 5))))
                    goto Found5;
                if (value.Equals(Unsafe.Add(ref searchSpace, IntPtr2.Add(index, 6))))
                    goto Found6;
                if (value.Equals(Unsafe.Add(ref searchSpace, IntPtr2.Add(index, 7))))
                    goto Found7;

                index = IntPtr2.Add(index, 8);
            }
        ...
        Found1:
            return (int)(byte*)(IntPtr2.Add(index, 1));
        Found2:
            return (int)(byte*)(IntPtr2.Add(index, 2));
        Found3:
            return (int)(byte*)(IntPtr2.Add(index, 3));
        Found4:
            return (int)(byte*)(IntPtr2.Add(index, 4));
        Found5:
            return (int)(byte*)(IntPtr2.Add(index, 5));
        Found6:
            return (int)(byte*)(IntPtr2.Add(index, 6));
        Found7:
            return (int)(byte*)(IntPtr2.Add(index, 7));
        }
            ...
            where T : IEquatable<T>
        {
            ...
            while (length >= 8)
            {
                ...
                if (!Unsafe.Add(ref first, index).Equals(Unsafe.Add(ref second, index)))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, IntPtr2.Add(index, 1)).Equals(Unsafe.Add(ref second, IntPtr2.Add(index, 1))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, IntPtr2.Add(index, 2)).Equals(Unsafe.Add(ref second, IntPtr2.Add(index, 2))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, IntPtr2.Add(index, 3)).Equals(Unsafe.Add(ref second, IntPtr2.Add(index, 3))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, IntPtr2.Add(index, 4)).Equals(Unsafe.Add(ref second, IntPtr2.Add(index, 4))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, IntPtr2.Add(index, 5)).Equals(Unsafe.Add(ref second, IntPtr2.Add(index, 5))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, IntPtr2.Add(index, 6)).Equals(Unsafe.Add(ref second, IntPtr2.Add(index, 6))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, IntPtr2.Add(index, 7)).Equals(Unsafe.Add(ref second, IntPtr2.Add(index, 7))))
                    goto NotEqual;
        ...
        public static bool SequenceEqual<T>(ref T first, ref T second, uint length)
            where T : IEquatable<T>
        {
            return SequenceEqual<T>(ref first, ref second, unchecked((int)length));
        }
